...
A threat model for a division calculator
...
|:----:|:----:|:---:|:----:|:--------:|:----:|
|User provides inputs|User|Web Server|Dividend, Divisor|HTTP|80|
|Server sends inputs to division process|Web Server|Division Process|Dividend, Divisor|Flask|5000|
|Division process returns result or error|Division Process|Web Server|Division Result, Error Message|Flask|-1|
|Server returns result or error|Web Server|User|Division Result, Error Message|HTTP|-1|
...
<details>
  <summary>   DE01   --   Interception</summary>
  <h6> Targeted Element </h6>
  <p> Server sends inputs to division process </p>
  <h6> Severity </h6>
  <p>Medium</p>
  <h6>Example Instances</h6>
  <p>Adversary tries to block, manipulate, and steal communications in an attempt to achieve a desired negative technical impact.</p>
...
<details>
  <summary>   DE01   --   Interception</summary>
  <h6> Targeted Element </h6>
  <p> Division process returns result or error </p>
  <h6> Severity </h6>
  <p>Medium</p>
  <h6>Example Instances</h6>
  <p>Adversary tries to block, manipulate, and steal communications in an attempt to achieve a desired negative technical impact.</p>
...
<details>
  <summary>   DE01   --   Interception</summary>
  <h6> Targeted Element </h6>
  <p> Server returns result or error </p>
  <h6> Severity </h6>
  <p>Medium</p>
  <h6>Example Instances</h6>
  <p>Adversary tries to block, manipulate, and steal communications in an attempt to achieve a desired negative technical impact.</p>
